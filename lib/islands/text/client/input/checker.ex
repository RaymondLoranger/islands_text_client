defmodule Islands.Text.Client.Input.Checker do
  use PersistConfig

  alias Islands.Text.Client.Input.RandomGuess
  alias Islands.Text.Client.Input
  alias Islands.Text.Client.Player.React.GameOver
  alias Islands.Text.Client.{Prompter, State}
